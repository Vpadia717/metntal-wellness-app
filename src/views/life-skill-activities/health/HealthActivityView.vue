...
const activities = [
    { id: 1, title: 'STRESS MANAGEMENT', route: '/activity/life-skills/health/stress-management' },
    { 
        id: 2, 
    ...
    { id: 3, title: 'PERSONAL SAFETY', route: '' },
    { id: 4, title: 'SELF ESTEEM', route: '' },
    { id: 5, title: 'MORAL REASONING', route: '' },
    { id: 6, title: 'HEALTHY LIFESTYLE ', route: '' },
];
