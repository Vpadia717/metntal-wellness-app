		...
		<div class="row">
			...
			<div class="col-12">
				<div class="form-floating mb-3">
					<select
						class="form-select"
						:class="{ 'is-invalid': errors.officer }"
						v-model.trim="appointment.officer"
						@blur="validateOfficer"
					>
						<option value="">Select</option>
						<option
							v-for="(officer, index) in wellnessOfficers"
							:key="index"
							:value="officer.id"
						>
							{{ officer.name }}
			...
			<div class="col-12">
				<div class="form-floating mb-3">
					<select
						...
						id="appointmentPlace"
						v-model.trim="appointment.place"
						@blur="validatePlace"
					>
						<option value="">Select</option>
						<option
			...
			<div class="col-12">
				<div class="form-floating mb-3">
					<select
						...
						id="availableSlots"
						v-model.trim="appointment.slots"
						@blur="validateSlots"
					>
						<option value="">Select</option>
						<option
